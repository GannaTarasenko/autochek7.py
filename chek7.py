...
class Vector:
    ...
    def __mul__(self, vector):
        if isinstance(vector, Vector):
            ...
            raise TypeError("Unsupported operand type(s) for *: 'Vector' and '{}'".format(type(vector)))
...
ерш ніж ми приступимо до операцій порівняння векторів, реалізуйте метод визначення довжини вектора - len для класу Vector
...
class Vector:
    ...
    def len(self):
        return (self.coordinates.x ** 2
                + self.coordinates.y ** 2) ** 0.5
